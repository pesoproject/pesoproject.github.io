...
- **Todd Gamblin** — co-founder; Governing Board Chair; HPSFCon program committee
- **Damien Lebrun-Grandié** — Governing Board; Technical Advisory Committee (TAC); HPSFCon program committee
- **Bill Hoffman** — TAC Chair
- **Jim Willenbring** — TAC
- **Sameer Shende** — TAC
- **Mike Heroux** — membership recruitment

PESO members (Gamblin, Heroux, Willenbring, Shende) also serve on Technical Steering Committees for HPSF projects including E4S and Spack. Forward plans include launching an HPSF CI/CD service with AWS, Azure, and the University of Oregon, participating in the CI/CD and Binaries working groups, and expanding HPSF participation and activities. Learn more at [hpsf.io](https://hpsf.io).
