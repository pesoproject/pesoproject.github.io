...
KNOWN_SLUGS = {
    ...
    "2026-08 PESO-DAVTOOLS-highlight.pptx": "dav-tools",
    ...
    "2026.08.ASCR.Highlight.PESO.ZeroToLAMMPS.pptx": "zero-to-lammps",
}
...
def main():
    ...
    # deck is temporarily removed), but list known ones first in the
    # order encountered above, followed by any leftovers.
    ...
    with open(DATA_FILE, "w") as f:
        ...
        f.write("# they are preserved across re-runs.\n")
        yaml.dump(
            ordered_entries,
            f,
            sort_keys=False,
